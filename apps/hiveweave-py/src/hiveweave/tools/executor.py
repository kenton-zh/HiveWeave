...
TOOL_PARAM_SCHEMAS: dict[str, dict] = {
    ...
    "spawn_subagent": {
        "description": (
            ...
            "FAILED] / [SUBAGENT DONE_TRUNCATED] (the last means it ran out "
            "of turn budget before finishing — its work may not have landed, "
            "so verify before relying on it). Give a complete standalone "
            "prompt. subagent_type is "
