...
export default function OfficeView() {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-g-bg-soft">
      ...
      {error && (
        <div className="absolute top-4 left-4 rounded-gmLg border border-g-red bg-g-red-bg/95 backdrop-blur-sm px-3.5 py-2.5 text-xs text-g-red z-10 shadow-gm-md flex items-center gap-2">
          <svg className="w-4 h-4 text-g-red-vivid shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      {!error && loading && agents.length === 0 && (
        <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
          <div className="flex items-center gap-2.5 rounded-gmLg bg-white/80 backdrop-blur-sm border border-g-border px-4 py-3 shadow-gm-md">
