...
export default function ConfirmDialog({
  ...
  return (
    ...
    >
      <div
        className="bg-g-bg border border-g-border rounded-xl shadow-2xl p-6 w-full max-w-md mx-4"
      ...
      >
        ...
        <div className="flex items-center justify-end gap-3">
          <button
            onClick={onCancel}
            className="px-4 py-2 text-sm text-g-fg-3 hover:text-g-fg border border-g-border rounded-lg hover:border-foreground-muted transition-colors"
          >
            {cancelLabel}
          </button>
          <button
